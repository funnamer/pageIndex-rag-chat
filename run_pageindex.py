...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default=os.getenv('OPENAI_MODEL', 'deepseek-chat'), help='Model to use')

    parser.add_argument('--toc-check-pages', type=int, default=8,
